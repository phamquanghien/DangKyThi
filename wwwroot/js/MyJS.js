...
function GetSubjectGroupByStudentID() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            html += '<select onchange="GetExamTimeBySubject();" class="w3-select w3-border w3-round w3-white w3-padding w3-mobile w3-col w3-large w3-margin-right" id="MySelect" name="CaThi"">'
